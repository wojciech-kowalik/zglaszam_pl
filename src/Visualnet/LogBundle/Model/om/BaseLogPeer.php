...
use Visualnet\LogBundle\Model\map\LogTableMap;

/**
 * Base static class for performing query and update operations on the 'visual_log' table.
 *
 * 
 *
...
abstract class BaseLogPeer {
	...
	const TABLE_NAME = 'visual_log';

	/** the related Propel class for this table */
	const OM_CLASS = 'Visualnet\\LogBundle\\Model\\Log';
	...
	const ID = 'visual_log.ID';

	/** the column name for the USER_ID field */
	const USER_ID = 'visual_log.USER_ID';

	/** the column name for the TYPE field */
	const TYPE = 'visual_log.TYPE';

	/** the column name for the MESSAGE field */
	const MESSAGE = 'visual_log.MESSAGE';

	/** the column name for the IP field */
	const IP = 'visual_log.IP';

	/** the column name for the CONTENT field */
	const CONTENT = 'visual_log.CONTENT';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'visual_log.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'visual_log.UPDATED_AT';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Type', 'Messsage', 'Ip', 'Content', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'type', 'messsage', 'ip', 'content', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::TYPE, self::MESSAGE, self::IP, self::CONTENT, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'TYPE', 'MESSAGE', 'IP', 'CONTENT', 'CREATED_AT', 'UPDATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'type', 'message', 'ip', 'content', 'created_at', 'updated_at', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Type' => 2, 'Messsage' => 3, 'Ip' => 4, 'Content' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'type' => 2, 'messsage' => 3, 'ip' => 4, 'content' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::TYPE => 2, self::MESSAGE => 3, self::IP => 4, self::CONTENT => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'TYPE' => 2, 'MESSAGE' => 3, 'IP' => 4, 'CONTENT' => 5, 'CREATED_AT' => 6, 'UPDATED_AT' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'type' => 2, 'message' => 3, 'ip' => 4, 'content' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(LogPeer::USER_ID);
			$criteria->addSelectColumn(LogPeer::TYPE);
			$criteria->addSelectColumn(LogPeer::MESSAGE);
			$criteria->addSelectColumn(LogPeer::IP);
			$criteria->addSelectColumn(LogPeer::CONTENT);
	...
	/**
	 * Method to invalidate the instance pool of all tables related to visual_log
	...
	/**
	 * Deletes all rows from the visual_log table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
