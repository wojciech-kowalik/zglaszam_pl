...
/**
 * Base class that represents a row from the 'visual_menu_i18n' table.
 *
 * 
 *
...
abstract class BaseMenuI18n extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'Visualnet\\MenuBundle\\Model\\MenuI18nPeer';
	 ...
	 * @return     MenuI18n The current object (for fluent API support)
	 */
	...
	public function setLocale($v)
	{
		...
		if ($this->locale !== $v) {
			$this->locale = $v;
			$this->modifiedColumns[] = MenuI18nPeer::LOCALE;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = MenuI18nPeer::NAME;
		}
	...
	public function setSlug($v)
	{
		...
		if ($this->slug !== $v) {
			$this->slug = $v;
			$this->modifiedColumns[] = MenuI18nPeer::SLUG;
		}
	...
	public function setContent($v)
	{
		...
		if ($this->content !== $v) {
			$this->content = $v;
			$this->modifiedColumns[] = MenuI18nPeer::CONTENT;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = MenuI18nPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = MenuI18nPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = MenuI18nPeer::NUM_HYDRATE_COLUMNS.
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = MenuI18nQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				if (!$this->isColumnModified(MenuI18nPeer::CREATED_AT)) {
					$this->setCreatedAt(time());
				}
				if (!$this->isColumnModified(MenuI18nPeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
			} else {
				$ret = $ret && $this->preUpdate($con);
				// timestampable behavior
				if ($this->isModified() && !$this->isColumnModified(MenuI18nPeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
			}
			if ($ret) {
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(MenuI18nPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(MenuI18nPeer::LOCALE)) {
			$modifiedColumns[':p' . $index++]  = '`LOCALE`';
		}
		if ($this->isColumnModified(MenuI18nPeer::NAME)) {
			$modifiedColumns[':p' . $index++]  = '`NAME`';
		}
		if ($this->isColumnModified(MenuI18nPeer::SLUG)) {
			$modifiedColumns[':p' . $index++]  = '`SLUG`';
		}
		if ($this->isColumnModified(MenuI18nPeer::CONTENT)) {
		...
		$sql = sprintf(
			'INSERT INTO `visual_menu_i18n` (%s) VALUES (%s)',
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MenuI18nPeer::LOCALE)) $criteria->add(MenuI18nPeer::LOCALE, $this->locale);
		if ($this->isColumnModified(MenuI18nPeer::NAME)) $criteria->add(MenuI18nPeer::NAME, $this->name);
		if ($this->isColumnModified(MenuI18nPeer::SLUG)) $criteria->add(MenuI18nPeer::SLUG, $this->slug);
		if ($this->isColumnModified(MenuI18nPeer::CONTENT)) $criteria->add(MenuI18nPeer::CONTENT, $this->content);
		if ($this->isColumnModified(MenuI18nPeer::CREATED_AT)) $criteria->add(MenuI18nPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(MenuI18nPeer::UPDATED_AT)) $criteria->add(MenuI18nPeer::UPDATED_AT, $this->updated_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(MenuI18nPeer::LOCALE, $this->locale);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of MenuI18n (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     MenuI18n Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getMenu(PropelPDO $con = null)
	{
		if ($this->aMenu === null && ($this->id !== null)) {
			$this->aMenu = MenuQuery::create()->findPk($this->id, $con);
	...
	{
		return (string) $this->exportTo(MenuI18nPeer::DEFAULT_STRING_FORMAT);
	}
